...
document.getElementById('loginForm').addEventListener('submit', (e) => {
    e.preventDefault();
    alert('Inicio de sesión exitoso (simulado). Redirigiendo al dashboard...');
    loginModal.style.display = 'none';
});
...
document.getElementById('facebookLogin').addEventListener('click', () => {
    alert('Iniciar sesión con Facebook (se implementará más tarde)');
});

document.getElementById('googleLogin').addEventListener('click', () => {
    alert('Iniciar sesión con Google (se implementará más tarde)');
});

document.getElementById('twitterLogin').addEventListener('click', () => {
    alert('Iniciar sesión con Twitter (se implementará más tarde)');
});

document.getElementById('facebookRegister').addEventListener('click', () => {
    alert('Registrarse con Facebook (se implementará más tarde)');
});

document.getElementById('googleRegister').addEventListener('click', () => {
    alert('Registrarse con Google (se implementará más tarde)');
});

document.getElementById('twitterRegister').addEventListener('click', () => {
    alert('Registrarse con Twitter (se implementará más tarde)');
});
});